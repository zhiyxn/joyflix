        ...
        customType: {
          m3u8: function (video: HTMLVideoElement, url: string) {
            ...
            const hls = new Hls({
              ...
              /* 缓冲/内存相关 */
              maxBufferLength: 50, // 前向缓冲最大 50s，过大容易导致高延迟
              backBufferLength: 50, // 仅保留 50s 已播放内容，避免内存占用
              maxBufferSize: 300 * 1000 * 1000, // 约 300MB，超出后触发清理
  ...
  if (loading) {
    return (
      <PageLayout activePath='/play'>
        <div className='flex items-center justify-center h-full md:min-h-screen bg-transparent'>
          <div className='text-center max-w-md mx-auto px-6 transform -translate-y-6 md:transform-none'>
            {/* New Animation */}
